...
<template>
    <div class="project-card bg-white shadow-md p-8 rounded-3xl border border-gray-200 w-full max-w-[600px]">
      <h2 class="text-xl font-bold text-gray-800">{{ projectData?.name }}</h2>
